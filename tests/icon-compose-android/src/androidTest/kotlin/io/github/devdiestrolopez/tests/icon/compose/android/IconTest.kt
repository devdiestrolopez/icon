package io.github.devdiestrolopez.tests.icon.compose.android
...
import io.github.devdiestrolopez.icon.compose.android.Icon
...
import io.github.devdiestrolopez.tests.icon.compose.android.test.R
...
internal class IconTest {
    ...
    fun drawableIconRendersCorrectly() {
        ...
        val testDrawableResource = DrawableResource(R.drawable.ic_info)
